...
public class FactoryTestConfServiceImpl extends ServiceImpl<FactoryTestConfMapper, FactoryTestConf> implements FactoryTestConfService {
    ...
    public R getPage(Long offset, Long size, String confName) {
        ...
        wrapper.eq(Objects.nonNull(conf.getId()), FactoryTestConf::getId, conf.getId())
                .like(Objects.nonNull(conf.getConfName()), FactoryTestConf::getConfName, conf.getConfName())
                .eq(FactoryTestConf::getDelFlag,FactoryTestConf.DEL_NORMAL)
                .orderByDesc(FactoryTestConf::getCreateTime);
